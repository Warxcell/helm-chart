...
| ----------------------------------- | ---------------------------------- | ------------------------------------- |
| `global.selenium.imageTag`      | `4.0.0-20211025`                   | Image tag for all selenium components |
| `global.selenium.nodesImageTag` | `4.0.0-20211025`                   | Image tag for browser's nodes         |
...
| `chromeNode.imageTag`                   | `4.0.0-20211025`                   | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                  | `4.0.0-20211025`                   | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                     | `4.0.0-20211025`                   | Image of edge nodes                                                                                                        |
...
| `hub.imageTag`                  | `nil`             | Selenium Hub image tag (this overwrites `.global.selenium.imageTag` value)                                                   |
...
| `components.router.imageTag`                  | `nil`                     | Router image tag (this overwrites `.global.selenium.imageTag` value)                                                         |
...
| `components.distributor.imageTag`             | `nil`                     | Distributor image tag  (this overwrites `.global.selenium.imageTag` value)                                                   |
...
| `components.eventBus.imageTag`                | `nil`                     | Event Bus image tag  (this overwrites `.global.selenium.imageTag` value)                                                     |
...
| `components.sessionMap.imageTag`              | `nil`                     | Session Map image tag  (this overwrites `.global.selenium.imageTag` value)                                                   |
...
| `components.sessionQueuer.imageTag`           | `nil`                     | Session Queuer image tag  (this overwrites `.global.selenium.imageTag` value)                                                |
